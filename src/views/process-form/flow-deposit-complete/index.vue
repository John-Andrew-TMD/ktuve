<!-- 保证金补足 -->
<template>
  <div class="flow-deposit-complete app-content white-bg pdb-20">
    <comp-deposit-complete
      v-if="urlParams"
      ref="actionDom"
      :row-data="rowData"
      :flow-info="flowInfo"
...
import CompDepositComplete from 'views/investment-mng/deposit-mng/components/components/CompDepositComplete.vue'
