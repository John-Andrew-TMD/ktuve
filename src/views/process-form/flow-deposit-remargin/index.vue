<!-- 保证金追加 -->
<template>
  <div class="flow-deposit-remargin app-content white-bg">
...
import CompDepositRemargin from 'views/investment-mng/deposit-mng/components/components/CompDepositRemargin.vue'
